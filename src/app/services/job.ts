  ...
  private jobs: Job[] = [
    {
      ...
      jobUpdates: [
        { status: JobStatus.NEW, updatedAt: new Date('2023-01-01') },
        { status: JobStatus.APPLIED, updatedAt: new Date('2023-01-05') }
      ]
    },
    {
      id: '2',
      ...
      jobUpdates: [
        { status: JobStatus.NEW, updatedAt: new Date('2023-02-01') },
        { status: JobStatus.INTERVIEW, updatedAt: new Date('2023-02-10') }
      ]
    }
  ];
